...
DATA_DIR = 'data'  # Pastikan folder 'data' hasil prepare_dataset.py ada di sini
...
BATCH_SIZE = 32
EPOCHS = 30       # Total epoch, tapi kita akan pakai Early Stopping
LEARNING_RATE_HEAD = 1e-3  # LR untuk melatih classifier head saja
LEARNING_RATE_FINETUNE = 5e-5 # LR untuk fine-tuning seluruh model
WEIGHT_DECAY = 0.01
