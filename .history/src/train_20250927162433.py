...
# Ambil classifier layer dari backbone timm
    classifier_module = model.backbone.get_classifier()
for param in classifier_module.parameters():
    param.requires_grad = True

    optimizer_head = optim.AdamW(classifier_module.parameters(), lr=LEARNING_RATE_HEAD, weight_decay=WEIGHT_DECAY)
